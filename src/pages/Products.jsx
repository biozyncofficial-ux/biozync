...
// BioZync Products Page - Black Theme
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'var(--gradient-bg)' }}>
      ...
      <style jsx>{`
        ...
        :root {
          ...
          --gradient-purple: linear-gradient(135deg, rgba(206, 183, 252, 0.1) 0%, rgba(206, 183, 252, 0.05) 100%);
        }
        ...
        .badge-purple {
          ...
          border: 1px solid rgba(206, 183, 252, 0.2);
        }

        .glow-purple {
          text-shadow: 0 0 20px rgba(206, 183, 252, 0.3);
        }
      `}</style>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            , we're pioneering the future with groundbreaking eco-technologies.
            Our innovative solutions tackle climate change head-on while
            promoting sustainable architecture and ecosystem regeneration.
          </p>
        </div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: index === 0 ? "var(--gradient-card)" : "var(--gradient-purple)",
                }}
              ></div>
...
>
  {product.description}
                ...
                <a
                  ...
                  style={{
                    background: index === 0 ? "var(--gradient-primary)" : "linear-gradient(135deg, #CEB7FC 0%, #00C095 100%)",
                    color: "white",
                    boxShadow: index === 0 ? "var(--shadow-glow)" : "0 4px 20px rgba(206, 183, 252, 0.3)",
                  }}
                >
                  {product.id === "c3SuperTree"
                    ? "Explore C3 Trees"
                    : "Discover C4 Trees"}
